...
export const CreateBoardModal = ({ isOpen, onClose, onCreateBoard, teamId }: CreateBoardModalProps) => {
  const [boardName, setBoardName] = useState('');
  const [selectedTemplate, setSelectedTemplate] = useState('blank');

  const templates = [
    { id: 'blank', name: 'Blank Canvas', description: 'Start with an empty canvas' },
    { id: 'brainstorm', name: 'Brainstorming', description: 'Sticky notes for idea generation' },
    { id: 'retrospective', name: 'Retrospective', description: 'What went well, what could improve' },
    { id: 'user-journey', name: 'User Journey', description: 'Map user experiences and touchpoints' }
  ];
